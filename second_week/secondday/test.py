...
from DLStudy.second_week.secondday import opt_utils, testCase
...
def model_optimizer(X, Y, layers_dims, optimizer, learning_rate=0.0007, mini_batch_size=64, beta=0.9, beta1=0.9,
                    beta2=0.999, epsilon=1e-8, num_epochs=10000, print_cost=True, is_plot=True):
    L = len(layers_dims)
    costs = []
...
parameters = model_optimizer(train_X, train_Y, layers_dims, optimizer="adam",is_plot=True)
