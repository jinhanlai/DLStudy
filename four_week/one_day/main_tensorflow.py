...
from DLStudy.four_week.one_day import cnn_utils
from DLStudy.four_week.testcase_paramer import load_parameters
...
def model(X_train, Y_train, X_test, Y_test, learning_rate=0.001,
    ...
    with tf.compat.v1.Session() as sess:
        ...
        corrent_prediction = tf.equal(predict_op, tf.math.argmax(Y, 1))
...
#
# Y_train = cnn_utils.convert_to_one_hot(Y_train_orig).T
# Y_test = cnn_utils.convert_to_one_hot(Y_test_orig).T
#
